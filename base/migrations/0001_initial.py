...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(help_text='Enter a book genre (e.g. Science Fiction)', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('genre', models.ManyToManyField(help_text='Select a genre for this book', to='base.genre')),
            ],
        ),
        migrations.CreateModel(
            name='BiikInstance',
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='base.book')),
            ],
            options={
                'ordering': ['due_back'],
            },
